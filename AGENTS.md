...
- Use cheaper subagents than the main thread by default: low reasoning for search/test discovery, medium for risk review, and high/xhigh only when explicitly asked or needed for deep architecture reasoning.
